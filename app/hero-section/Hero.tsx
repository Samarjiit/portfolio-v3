  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/1o-rSvfPCmcVux3ZZFMw7ZHN1IjbK3qLC/view?usp=sharing"
            target="_blank"
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          ...
          <Link
            href="https://www.linkedin.com/in/samarjit-mahi/"
            target="_blank"
          ...
          <Link
            href="https://twitter.com/hisamarmahi"
            target="_blank"
          ...
          <Link
            href="https://leetcode.com/samarpreneur/"
            target="_blank"
        ...
        >
          ...
          >
            <Image
              ...
              priority
              alt="Samarjit Mahi"
              data-blobity-tooltip="The Lean Programmer"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Full Stack Developer and an aspiring Software Engineer.
            <Link
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Student of Manipal institute of technology,Upupi.
          </p>
        </motion.div>
      </div>
    </motion.section>
